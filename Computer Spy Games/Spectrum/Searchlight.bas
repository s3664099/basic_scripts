...
180 GOSUB 400
190 IF A$(A,N+1)=" " AND L=1 THEN GOTO 240
...
410 IF C=TC THEN LET L=0:LET C=0:LET TC=INT(RND*8+(12-A)):GOSUB 320
420 IF L=0 THEN LET C1=C1+1
430 IF C1=TC THEN LET L=1:LET C1=0:LET TC=INT(RND*10+(8+A)):GOSUB 300
440 RETURN
450 DIM A$(7,20)
