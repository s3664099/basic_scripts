...
280 IF NE=3 AND RND(10)>3 AND V<>1 THEN LET B$="ENEMY AGENT SEES YOU!":GOTO 70
...
340 IF RND(10)>9 THEN LET EP=10
350 GOTO 70
...
660 LET NP=RND(20):GOSUB 950:LET P=NP
670 IF RND(10)>8 THEN LET P=KP
680 IF RND(10)>7 THEN B$="YOU LOST HIM AFTER A WHILE!":RETURN
690 LET EP=P
...
1130 LET H=RND(2)+8:LET M=0
1140 LEF FH=RND(2)+14
1150 LET CH=RND(2)+H
1160 CLS:PRINT:PRINT
1170 LET NE=0:LET T$="CONTACT IS HERE"
1180 LET MP=RND(18):LET KP=RND(18)
1190 LET EP=RND(18):LET CP=RND(18)
1200 FOR I=1 TO RND(6)
1210 READ P$:NEXT I
1220 LET NL=RND(900)+99
