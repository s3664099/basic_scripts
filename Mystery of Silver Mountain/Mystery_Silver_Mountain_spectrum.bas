10 LET EL=32:LET NO=88:LET NV=57:LET G=28
20 GOSUB 3380
30 GOSUB 4400
40 LET LL=0
50 GOSUB 3310
60 LET P$=X$(VAL(D$(1)))
61 IF P$(1)=" " THEN LEFT P$="":GOTO 69
63 IF P$(LEN(P$))=" " THEN LET P$=P$( TO LEN(P$)-1):GOTO 63
65 LET P$=P$+" "+Y$(VAL(D$(2)))
68 IF P$(LEN(P$))=" " THEN LET P$=P$( TO LEN(P$)-1):GOTO 68
69 LET P$=P$+" "
70 LET J$=R$+". "+"YOU ARE "+P$+D$(3 TO )+" ":GOSUB 4830
80 GOSUB 3330:LET J$=""
90 FOR I=1 TO G-1
100 READ O$
...
310 IF I$(1)=" " AND V$="" THEN LET V$=I$( TO I-1)
320 IF I$(I+1)<>" " AND V$<>"" THEN LET T$=I$(I+1 TO ):LET I=LEN(I$)
330 NEXT I:IF T$="" THEN LET V$=I$
340 IF LEN(V$)<3 THEN LET V$=V$+"O":GOTO 340
350 IF V$="PLAY" THEN LET V$="BLO"
360 LET U$=V$( TO 3)
370 FOR I=1 TO NV:IF B$(I*3-2 TO I*3)=U$ THEN LET VB=I:LET I=NV
...
510 IF R=56 AND F(35)=0 AND VB<>37 AND VB<>53 THEN LET R$="THE GHOST OF THE GOBLIN GUARDIAN HAS GOT YOU!":GOTO 30
520 IF VB=44 OR VB=47 OR VB=19 OR VB=57 OR VB=49 THEN GOTO 540
530 IF R=48 AND F(63)=0 THEN LET R$="THE WIZARD HAS YOU IN HIS GLARE":GOTO 30
...
670 IF R=56 AND F(35)=0 AND C(10)<>0 THEN LET R$="THE GHOST OF THE GOBLIN GUARDIAN GETS YOU!":LET F(56)=1
...
890 IF R=73 OR R=42 OR R=9 OR R=10 THEN LET R$="A GRARG PATROL APPROACHES":LET F(55)=1:RETURN
...
950 IF ((R=3 AND D=2) OR (R=4 AND D=4)) AND F(45)=0 THEN LET R$="A PILE OF RUBBLE BLOCKS YOUR PATH":RETURN
...
1820 IF H=2228 AND C(5)=81 THEN LET R$="HE LEADS YOU NORTH":LET C(28)=81:LET R=12
1830 IF (H=2228 AND C(5)=0) OR H=225 THEN LET R$="HE LEADS YOU NORTH":LET R=12
1840 IF (H=1228 AND C(5)=0) OR H=125 THEN LET R$="HE LEADS YOU SOUTH":LET R=22
...
1920 IF B=71 AND F(60)=0 THEN LET R$="THE MOUNTAIN RUMBLES!":LET F(60)=1:RETURN
...
2440 RETURN
2450 IF B=22 AND F(37)=1 AND F(34)=1 THEN LET R$="B MBSHF WJOF HSPXT JO TFDPOET!":LET F(38)=1:GOSUB 4260
2460 RETURN
...
2900 IF H=5610 THEN LET F(35)=1:LET R$="THE GHOST OF THE GOBLIN GUARDIAN IS FREE!":LET E$(56)="NS"
2910 RETURN
...
3060 RETURN
3070 IF (H=4864 OR H-4819) AND C(19)=0 THEN LET R$="ZPV SFGMFDUFE UIF XJABSET HMBSF! IF JT EFBE""A GRARG PATROL APPROACHES":LET F*63)=1:GOSUB 4260
...
3300 LET R$="MAGIC WORDS LIE AT THE CROSSROADS, THE FOUNTAIN AND THE "+RIGHT$(D$,LEN(D$)-2):RETURN
...
4690 X=OPENIN(FL$):PRINT "OK. LOADING"
...
4760 REM
4770 X=OPENOUT(FL$):PRINT "OK. SAVING"
