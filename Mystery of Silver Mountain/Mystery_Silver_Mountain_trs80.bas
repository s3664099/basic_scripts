5 CLEAR 700
10 LET EL=31:LET NO=88:LET NV=57:LET G=28
20 GOSUB 3380
30 GOSUB 4400
40 LET LL=0
50 GOSUB 3310
...
4480 LET F(41)=INT(RND(0)*900)+100:LET F(42)=INT(RND(1)*3)+2
4490 LET F(44)=4:LET F(57)=68:LET F(58)=54:LET F(59)=15:LET F(52)=INT(RND(0)*3)
4500 LET R=77:LET R$="GOOD LUCK ON YOUR QUEST!"
4510 LET G$(1)="":FOR I=1 TO 8
4520 LET F$=MID$(B$,1+INT(RND(0)*4)*3,1)
4530 LET G$(1)=G$(1)+F$
...
4670 INPUT "PRESS PLAY ON TAPE, THEN PRESS ENTER";J$
4680 PRINT "OK. SEARCH FOR ";FL$
4690 OPEN "I",#-1,FL$:PRINT "OK. LOADING"
...
4760 PRINT "PRESS RECORD AND PLAY, THEN PRESS ENTER";J$
4770 OPEN "O",#-1,FL$:PRINT "OK. SAVING"
