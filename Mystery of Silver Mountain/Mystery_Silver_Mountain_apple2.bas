...
4690 D$="(Press control D)":PRINT D$;"OPEN"+FL$:PRINT D$;"READ"+FL$
4700 FOR I=1 TO 80:INPUT E$(I):NEXT
4710 FOR I=1 TO G:INPUT C(I):NEXT
4720 FOR I-1 TO 70:INPUT F(I):NEXT
4730 INPUT G$(1):INPUT G$(2)
4740 PRINT D$;"CLOSE"+FL$:RETURN
4750 REM SAVE DATA FILE
4760 REM
4770 D$="(Press control D)":PRINT D$;"OPEN"+FL$:PRINT D$;"WRITE"+FL$
4780 FOR I=1 TO 80:PRINT E$(I):NEXT
4790 FOR I=1 TO G:PRINT C(I):NEXT
4800 FOR I=1 TO 70:PRINT F(I):NEXT
4810 PRINT G$(1):PRINT G$(2)
4820 PRINT D$;"CLOSE"+FL$:RETURN
