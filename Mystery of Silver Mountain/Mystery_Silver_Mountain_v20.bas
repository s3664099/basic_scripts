...
690 GOSUB 4400:J$=R$+" ":GOSUB 4830:PRINT
700 PRINT "YOU HAVE FAILED IN":PRINT "YOUR QUEST!"
710 PRINT:PRINT "BUT YOU ARE GRANTED ANOTHER TRY"
720 GOSUB 3360:RUN
730 GOSUB 4400
740 PRINT "HOOOOORRRRRRAAAAAYYYYYY!"
750 PRINT
760 PRINT "YOU HAVE SUCCEEDED IN"
770 PRINT "YOUR QUEST AND BROUGHT"
780 PRINT "PEACE TO THE LAND"
790 STOP
800 D=VB
810 IF D=5 THEN D=1
820 IF D=6 THEN D=3
...
900 IFC(8)=0AND((R=52ANDD=2)OR(R=31ANDD<>3))THENR$="THE BOAR IS TOO HEAVY":RETURN
...
1040 IF R=58 AND (D=1 OR D=4) AND F(66)=0 THEN R$="YOU GET CAUGHT IN THE WEBS!":RETURN
...
3430 B$=B$+"LIGFILPLAWATSWIEMPENTCROREMFEETURDIVDAILEATHRINSBLODROEATMOV"
...
3680 DATA 31MARSHY IN,23RUSTY GATES
...
4100 DATA COBWEBS,COIN,BELL,UP SILVER PLATE,STONES,KITCHENS,GOB,WINE
