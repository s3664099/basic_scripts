10 LET L=INT(RND(0)*3+5)
20 LET P=INT(RND(0)*60+40)
30 LET M=INT(RND(0)*50+10)*P
40 LET FP=INT(RND(0)*40+80)
50 LET CE=INT(RND(0)*40+80)
60 LET C=0
70 LET S=1
80 LET Y=1
90 LET LP=INT(RND(0)*2000+2000)
100 LET CP=INT(RND(0)*12+7)
110 CLS
120 PRINT "YEAR";Y
130 PRINT
...
500 IF S>1.1 THEN LET CE=CE+INT(RND(0)*20+1)
510 IF S<.9 THEN LET CE=CE-INT(RND(0)*20+1)
530 IF S>1.1 THEN LET P=P+INT(RND(0)*10+1)
540 IF S<.9 THEN LET P=P-INT(RND(0)*10+1)
550 IF P<30 THEN GOTO 700
560 IF RND(0)>.01 THEN GOTO 590
