...
40 GOSUB 650:GOSUB 2770:PRINT "ISLAND OF SECRETS": PRINT "TIME REMAINING:";L
50 PRINT G$;TAB(1)"STRENGTH = ";INT(Y);TAB(23);"WISDOM = ";X:PRINT G$
...
2550 PRINT G$:TAB(1);" FOOD=";F;TAB(23);"DRINK=";G:PRINT G$;:LET F$="OK"
2560 FOR I=1 TO C4
...
2620 IF A=40 THEN PRINT FL$;"OPEN ISDATA":PRINT FL$;"READ ISDATA"
2630 IF A=41 THEN PRINT FL$;"OPEN ISDATA":PRINT FL$;"WRITE ISDATA"
2640 IF A=41 THEN LET F(50)=R:LET F(49)=Y:LET F(48)=X:LET F(47)=F:LET F(46)=B:LET F(45)=L
2650 FOR I=1 TO W
2660 IF A=40 THEN INPUT L(I):INPUT F(I)
2670 IF A=41 THEN PRINT L(I):PRINT F(I)
2680 NEXT I
2690 PRINT FL$;"CLOSE ISDATA"
...
4390 FOR I=1 TO W+1
4400 READ L(I):LET F(I)=ASC(MID$(Q$,I,1))-48
4410 NEXT I
4420 LET H$="STONY WORDS"
4430 DEF FNR(Z)=INT(RND(1)*Z)+1
4440 DEF FNP(Z)=POS(0)
4450 DEF FNS(Z)=Y-(E/C4+.1)
4455 FL$=CHR$(4)
4460 RETURN 
4470 DATA 45,46,71,41,44,21,27,15,53,62,75,58,80,67,44,5,44,42,60,21,44,42,77
4480 DATA 13,33,44,58,15,51,75,41,78,71,50,77,23,19,10,10,45,42,38,38,0,0
