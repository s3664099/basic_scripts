...
2620 IF A=40 THEN OPEN "I",#-1,"ISDATA"
2630 IF A=41 THEN OPEN "O",#-1,"ISDATA"
2640 IF A=41 THEN LET F(50)=R:LET F(49)=Y:LET F(48)=X:LET F(47)=F:LET F(46)=B:LET F(45)=L
2650 FOR I=1 TO W
2660 IF A=40 THEN INPUT#-1,L(I),F(I)
2670 IF A=41 THEN PRINT#-1,L(I),F(I)
2680 NEXT I
2690 CLOSE#-1
...
4460 RETURN 
4500 LET B$=STR$(0)+STR$(L(O))+STR$(F(O))+STR$(R)
4510 LET B$=STR$(VAL(B$)):LET B$=RIGHT$(B$,LEN(B$)-1)
4520 RETURN