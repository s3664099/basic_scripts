...
55 LET LI=VAL(A$(I))
60 PRINT"YOU ARE ";I$(LI)( TO H(LI)):GOSUB720;LET N=0
70 FOR I=1 TO C4
80 LET C=0:READ Y$
...
240 FOR I=1 TO V
250 IF C$( TO 3)=V$(3*(I-1)+1 TO 3*(I-1)+3) THEN LET A=1
260 NEXT I
270 GOSUB 760
...
1490 IF B$=( TO 2)="80" AND N=43 THEN LET L(O)=81:GOSUB 1560
...
1790 IF B$( TO 4)="1100" AND R=10 THEN GOSUB 1980
...
1880 IF B$( TO 4)="1400" AND R=L(39) THEN GOSUB 1980
...
1980 GOSUB2770:GOSUB 2010*((O-10)=1)+2060*((O-10)>1)
...
2080 IF R=10 AND R=L(39)THEN LET A$=A$+" WHICH DISOLVES OMEGAN'S CLOAK":LET Y=Y+20
2090 RETURN
...
2160 FOR I=1TO R
2170 LET Y=FNS(Z):IF B$(I)="N" THEN LET J=J+1
...
2240 IF A$>"0" AND A$<"4" THEN LET R=CODE("A >"(VAL(A$)))-2:LET F(22)=-R
...
2280 IF B$="3371071" AND A=28 THEN LET F(3)=0:LET F$="HOW WILL YOU DO THAT"
2290 RETURN
...
2390 GOSUB2770 :PRINT"YOU TASTE A DROP AND..":GOSUB2760:LET F$="*OUCH":LET Y=Y-4:LET X=X-7
...
2620 REM
2630 REM
2640 IF A=41 THEN LET F(50)=R:LET F(49)=Y:LET F(48)=X:LET F(47)=F:LET F(46)=B:LET F(45)=L
2650 REM
2660 IF A=40 THEN LOAD "ISDATA" DATA L():LOAD "ISDATA" F()
2670 IF A=41 THEN SAVE "ISDATA" DATA L():SAVD "ISDATA" F()
2680 REM
2690 REM
...
2760 FOR D=1 TO 70:NEXT D:RETURN
2770 CLS:RETURN
2780 RESTORE LR+810
2790 RETURN
...
2890 DATA"7A PATH OF OUT THE OVERGROWN DEPTHS1000"
2900 DATA"6A CARNIVEROUS TREE1000"
...
2940 DATA"4THE SLUDGE FERMATION VATS1110"
...
3020 DATA"7THE EDGE OF THE CRIMSON CANYON0011"
...
3070 DATA"4SLEM'S INNER CHAMBER0111"
3080 DATA"3THE SOUTHERN EDGE OF THE FOREST1010"
3090 DATA"7A LEAFY PATH1000"
3100 DATA"3A FORK IN THE PATH0100"
3110 DATA"7AN APPARENTLY UNCLIMABLE ROCKY PATH1100"
...
3240 DATA"4A CHAMBER INCHES DEEP WITH DUST"
3250 DATA"4HERE1111"
...
3380 DATA"4THE LOGMAN'S HALL0000"
...
3460 DATA"4A DESERTED ABODE HUT1010"
...
3540 DATA"7A BARREB BLASTED WASTELAND0001"
3550 DATA"4AN EXPANSE OF BLEAK, BURNT LAND1100"
3560 DATA"5A DELAPIDATED ABODE HUT0110"
3570 DATA"4THE HEART OF THE LILLIES0101"
3580 DATA"4THE MIDST OF THE LILLIES1100"
3590 DATA"3A RIVER'S EDGE BY A LOG BRIDGE0100"
3600 DATA"3A PETRIFIED VILLAGE BY A RIVER CROWDED WITH LILLIES0100"
...
3660 DATA"4A HOLLOW CHAMBER MANY METERS IN DIAMETER1110"
...
4220 LET L$="REMEMBER ALADIN IT WORKED FOR HIM"
...
4310 LET T$="AND ARE TAKEN TO THE ISLAN OF SECRETS"
