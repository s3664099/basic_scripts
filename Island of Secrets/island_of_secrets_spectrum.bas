...
120 NEXT I
130 IF N>0 THEN LET A$="*YOU SEE"+A$:GOSUB 720
140 PRINT:PRINT G$;F$
...
770 FOR I=1 TO W
780 IF I$( TO 3)=Z$(3*(I-1)+1 TO 3*(I-1)+3) THEN LET O=1
...
2280 IF B$="3371071" AND A=28 THEN LET F(3)=0:F$="SHE NODS SLOWLY":X=X+5
2290 RETURN
