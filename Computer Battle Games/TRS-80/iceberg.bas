10 PRINT "ICEBERG"
20 DIM B(8,8)
30 LET N=INT(RND(0)*8+4)
40 FOR I=1 TO N
50 LET B(INT(RND(0)*8+1),INT(RND(0)*8+1))=42
60 NEXT I
70 LET SX=INT(RND(0)*8+1)
80 LET SY=INT(RND(0)*8+1)
90 IF B(SX,SY)<>0 THEN GOTO 70
100 LET B(SX,SY)=90
110 LET YX=INT(RND(0)*8+1)
120 LET YY=INT(RND(0)*8+1)
