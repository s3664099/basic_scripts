...
540 GOSUB 650
550 LET W(E(H)-1,H)=0
560 IF V*COS(2)>50 THEN LET W(E(H)-2,H)=0
570 IF RND(0)>.5 AND H<>1 THEN LET W(E(1),1)=29
580 IF RND(0)>.5 AND H>5 AND H<8 THEN LET W(E(H+1)-1,H+1)=0
590 IF H>1 THEN GOTO 630
600 FOR Y=2 TO 8
610 IF RND(0)<.5 THEN LET W(E(Y)-1,Y)=0
620 NEXT Y
630 GOSUB 650
640 RETURN
650 FOR Y=1 TO 8
...
830 PRINT "HIS MAGIC."
840 PRINT "YOU MUST DESTORY THE"
850 PRINT "WALL USING CATAPULTS,"
860 PRINT "BUT BEWARD, THE WIZARD"
...
1120 PRINT IF INKEY$="" THEN GOTO 1120
1130 CLS
1140 RETURN
