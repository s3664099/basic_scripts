...
70 LET D=INT(RND(0)*800+101)
80 LET E=INT(RND(0)*400+401)
...
280 PRINT
290 FOR I=1 TO INT(RND(0)*5+6)
300 IF RND(0)>.5 THEN GOTO 430
310 ON INT(RND(0)*4+1) GOTO 320,350,380,410
320 PRINT "ASTEROID STORM - SHIELDS DAMAGED"
330 LET S=S-20-INT(RND(0)*40+1)
340 GOTO 430
350 PRINT "COMPUTER BREAKDOWN - DELAY IN REPAIRING"
360 LET D=D+INT(RND(0)*20+1)
370 GOTO 430
380 PRINT "ENGINE TROUBLE - MUST SLOW DOWN"
390 LET V=V-.5
400 GOTO 430
410 PRINT "X-RAY DAMAGE - LIFE SUPPORT DAMAGED"
420 LET L=L-20-INT(RND(0)*40+1)
430 FOR J=1 TO 500
440 NEXT J
450 NEXT I
460 LET T1=INT(D/V)
